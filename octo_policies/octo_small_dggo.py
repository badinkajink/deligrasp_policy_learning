...
EXP_LOG_PATH = "C:/workspace/deligrasp_policy_learning/logs/octo_small_1.5_grasponly" # UPDATE WITH PATH TO DESIRED LOGGING DIRECTORY
...
EXP_LOG_PATH = "/mnt/c/workspace/deligrasp_policy_learning/logs/octo_small_1.5_grasponly"
...
def main(_):
    ...
    wandb.init(name="octo_sm_dg_go", project="jaf")
    ...
    dataset = make_single_dataset(
        dataset_kwargs=dict(
            name="deligrasp_dataset_grasponly",
